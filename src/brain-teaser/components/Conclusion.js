...
export default function Conclusion({quit,nextLevel,savedTime}) {
    return (
        <Card 
      ...
      >
        ...
        zIndex:10
           ...
           <div className={styles.conclusion_levelDetails}>
               <div className={styles.conclusion_levelDetail}><b>Saved time : </b><span>{savedTime}</span></div>
           ...
           <div className={styles.conclusion_action_btns}>
               <Button className={styles.conclusion_nextLevel_btn} onClick={()=>nextLevel(true)} text={'LEVEL 2'}/>
               <Button className={styles.conclusion_quit_btn} onClick={()=>quit(true)} text={'QUIT'}/>
           </div>
